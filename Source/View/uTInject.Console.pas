...
begin
  ...
  Lbl_Caption.Caption       := Lbl_Caption.Caption + ' CEF lib ' + uTInject.ConfigCEF.GlobalCEFApp.LibCefVersion + ' Chrome ' + uTInject.ConfigCEF.GlobalCEFApp.ChromeVersion; //+ ' TInject V. ' + TInjectVersion;
